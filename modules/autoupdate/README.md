...
2. **API Query**: Fetches latest version from `https://api.tavuru.de/version/foxnetworkBV/nginx-egg`
...
### Version API
```bash
GET https://api.tavuru.de/version/foxnetworkBV/nginx-egg
```

### Diff API
```bash
GET https://api.tavuru.de/diff/foxnetworkBV/nginx-egg/{from}/{to}?zip=true
```
