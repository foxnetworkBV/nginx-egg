...
echo "[Git] Cloning default repository 'https://github.com/foxnetworkBV/nginx-egg' into temporary directory."
git clone https://github.com/foxnetworkBV/nginx-egg /mnt/server/gtemp > /dev/null 2>&1 && echo "[Git] Repository cloned successfully." || { echo "[Git] Error: Default repository clone failed."; exit 21; }
